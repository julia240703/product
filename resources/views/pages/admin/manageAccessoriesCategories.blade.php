    ...
    <title>Kelola Kategori Aksesoris</title>
        ...
        <div class="container-fluid">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addUserModalLabel">Tambah Kategori Aksesoris</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form id="addCategoryForm" method="POST" action="{{ route('admin.accessories-categories.store') }}">
                                @csrf
                                <div class="mb-3">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel">Ubah Data Kategori Aksesoris</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form id="editForm">
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form method="POST" action="{{ route('admin.accessories-categories.destroy') }}">
                        @csrf
                        @method('DELETE')
            ...
            <script>
                $(document).ready(function() {
                    var dataTable = $('#category-table').DataTable({
                        ...
                        processing: true,
                        serverSide: true,
                        ajax: "{{ route('admin.accessories-categories.data') }}",
                        columns: [
                    ...
                    $('#updateBtn').on('click', function() {
                        $.ajax({
                            url: "{{ route('admin.accessories-categories.update') }}",
                            method: "POST",
                            data: {
                                _token: '{{ csrf_token() }}',
                                id: $('#categoryId').val(),
