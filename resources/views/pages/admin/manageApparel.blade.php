...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <button type="button" class="btn btn-success btn-sm mb-3" data-bs-toggle="modal" data-bs-target="#confirm">Tambah Aksesoris
        </button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="confirmLabel">Tambahkan Aksesoris</h5>
                    ...
                    <form action="{{ route('store.exam') }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-outline mb-3">
                                <label class="text-bold mb-1"s>Nama Aksesoris <span class="text-red mt-2">*</span></label>
                            ...
                            <!-- Time input -->
                            <div class="form-outline mb-3">
                                <label class="text-bold mb-1">Material <span class="text-red mt-2">*</span></label>
                                <input type="text" id="duration" name="duration" class="form-control" required />
                            </div>

                            <!-- Limit input -->
                            <div class="form-outline mb-3">
                                <label class="text-bold mb-1">Part Number <span
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel">Ubah Aksesoris</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body text-bold">
                        <form id="editForm">
                            ...
                            <div class="mb-3">
                                <label for="name" class="form-label">Nama Aksesoris <span
                                        class="text-red mt-2">*</span></label>
                                <input type="text" class="form-control" id="name" required />
                            </div>
                            <div class="mb-3">
                                <label for="description" class="form-label">Deskripsi Aksesoris <span
                                        class="text-red mt-2">*</span></label>
