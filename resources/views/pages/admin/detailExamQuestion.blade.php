                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <a href="{{ route('download.multiple.choice.xlsx') }}" class="btn btn-success btn-sm">Download Contoh File</a>

                            <form id="bulkInsertForm" action="{{ route('question.bulk-insert', ['quiz' => $quiz->id]) }}" method="post" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-outline mb-3">
                                      ...
                                      <textarea type="text" id="option_a" name="option_a" class="form-control" required></textarea>
                                  </div>
                                  ...
                                  <div class="form-outline mb-3">
                                      ...
                                      <textarea type="text" id="option_b" name="option_b" class="form-control" required></textarea>
                                  </div>
                                  ...
                                  <div class="form-outline mb-3">
                                      ...
                                      <textarea type="text" id="option_c" name="option_c" class="form-control" required></textarea>
                                  </div>
                                  ...
                                  <div class="form-outline mb-3">
                                      ...
                                      <textarea type="text" id="option_d" name="option_d" class="form-control" required></textarea>
                                  </div>
                                  ...
                                  <div class="form-outline mb-3">
                                      ...
                                      <textarea type="text" id="option_e" name="option_e" class="form-control"></textarea>
                                  </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-outline mb-3" id="questionDiv1">
                                      ...
                                      <textarea type="text" id="question1" name="question1" class="form-control"></textarea>
                                  </div>
                ...
                <div class="modal-body text-bold">
                  <form id="editFormQuestion">
                    ...
                    <div class="form-outline mb-3">
                        <input type="radio" name="radio_option" value="A">
                          <label class="text-bold mb-1">Pilihan A <span class="text-red mt-2">*</span></label>
                        <textarea type="text" id="option_a2" name="option_a2" class="form-control" required></textarea>
                    </div>
                    ...
                    <div class="form-outline mb-3">
                        <input type="radio" name="radio_option" value="B">
                          <label class="text-bold mb-1">Pilihan B <span class="text-red mt-2">*</span></label>
                        <textarea type="text" id="option_b2" name="option_b2" class="form-control" required></textarea>
                    </div>
                    ...
                    <div class="form-outline mb-3">
                        <input type="radio" name="radio_option" value="C">
                          <label class="text-bold mb-1">Pilihan C <span class="text-red mt-2">*</span></label>
                        <textarea type="text" id="option_c2" name="option_c2" class="form-control" required></textarea>
                    </div>
                    ...
                    <div class="form-outline mb-3">
                        <input type="radio" name="radio_option" value="D">
                          <label class="text-bold mb-1">Pilihan D <span class="text-red mt-2">*</span></label>
                        <textarea type="text" id="option_d2" name="option_d2" class="form-control" required></textarea>
                    </div>
                    ...
                    <div class="form-outline mb-3">
                        <input type="radio" name="radio_option" value="E">
                          <label class="text-bold mb-1">Pilihan E (opsional)</label>
                        <textarea type="text" id="option_e2" name="option_e2" class="form-control"></textarea>
                    </div>
                ...
                <div class="modal-body text-bold">
                  <form id="editFormImage">
                    ...
                    <div class="form-outline mb-3">
                        <input type="radio" name="radio_option" value="A">
                          <label class="text-bold mb-1">Pilihan A <span class="text-red mt-2">*</span></label>
                        <textarea type="text" id="option_a3" name="option_a3" class="form-control" required></textarea>
                    </div>
                    ...
                    <div class="form-outline mb-3">
                        <input type="radio" name="radio_option" value="B">
                          <label class="text-bold mb-1">Pilihan B <span class="text-red mt-2">*</span></label>
                        <textarea type="text" id="option_b3" name="option_b3" class="form-control" required></textarea>
                    </div>
                    ...
                    <div class="form-outline mb-3">
                        <input type="radio" name="radio_option" value="C">
                          <label class="text-bold mb-1">Pilihan C <span class="text-red mt-2">*</span></label>
                        <textarea type="text" id="option_c3" name="option_c3" class="form-control" required></textarea>
                    </div>
                    ...
                    <div class="form-outline mb-3">
                        <input type="radio" name="radio_option" value="D">
                          <label class="text-bold mb-1">Pilihan D <span class="text-red mt-2">*</span></label>
                        <textarea type="text" id="option_d3" name="option_d3" class="form-control" required></textarea>
                    </div>
                    ...
                    <div class="form-outline mb-3">
                        <input type="radio" name="radio_option" value="E">
                          <label class="text-bold mb-1">Pilihan E (opsional)</label>
                        <textarea type="text" id="option_e3" name="option_e3" class="form-control"></textarea>
                    </div>
...
<script>
  $(document).ready(function() {
    ...
    var dataTable = $('#question-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('detail.exam', ['quiz' => $quiz->id]) }}",
            data: function(d) {
