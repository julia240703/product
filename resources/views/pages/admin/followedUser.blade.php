        ...
        <div class="container-fluid">
          ...
          <div class="title-wrapper pt-30">
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="title">
                  <h2>Peserta yang telah direspon (Follow Up)</h2>
                </div>
              </div>
              <!-- end col -->
              <div class="col-md-6">
...
$(document).ready(function() {
    ...
    var table = $('#users-result-table').DataTable({
        ...
        order: [[6, 'desc'], [7, 'desc'], [8, 'desc']], // Order by progress (column index 5) and average score (column index 6) in descending order
