    ...
    <title>Kelola Kategori Parts</title>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addUserModalLabel">Tambah Kategori Parts</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form id="addCategoryForm" method="POST" action="{{ route('admin.parts-categories.store') }}">
                                @csrf
                                <div class="mb-3">
            ...
            <script>
                $(document).ready(function() {
                    var dataTable = $('#category-table').DataTable({
                        ...
                        processing: true,
                        serverSide: true,
                        ajax: "{{ route('admin.parts-categories.data') }}",
                        columns: [
                    ...
                    $('#updateBtn').on('click', function() {
                        $.ajax({
                            url: "{{ route('admin.parts-categories.update') }}",
                            method: "POST",
                            data: {
                                _token: '{{ csrf_token() }}',
                                id: $('#categoryId').val(),
