...
@section('content')
    <div class="container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="title mb-30">
                        <h2>Data Kategori {{ ucfirst($type) }}</h2>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <button type="button" class="btn btn-success mb-3 btn-sm" data-bs-toggle="modal" data-bs-target="#addModal">Tambah Kategori</button>

        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addUserModalLabel">Tambah Kategori {{ ucfirst($type) }}</h5>
                    ...
                    <div class="modal-body">
                        <form id="addCategoryForm" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="kategori" name="name" required />
                            </div>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel">Ubah Data Kategori</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="editForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="kategori_edit" name="name" required />
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
...
$(document).ready(function() {
    var dataTable = $('#category-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('admin.categories.data', ['type' => $type]) }}",
            data: function (d) {
                d._t = Date.now(); // biar nggak cache
            }
        },
        columns: [
    ...
    $('#addCategoryForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                dataTable.ajax.reload(null, false); // false biar tetap di halaman sekarang
            },
            error: function(xhr) {
    ...
    $(document).on('click', '.editBtn', function() {
        ...
        $('#kategori_edit').val($(this).data('name'));
