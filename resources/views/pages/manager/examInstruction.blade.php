        ...
        <div class="card-body mx-2">
            ...
            @foreach ($questions as $index => $question)
                @if ($question->image)
                    ...
                    <img src="{{ asset('files/question/' . $question->image) }}" alt="Question Image" class="img-fluid mb-4" style="width: 50%;">
                @else
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('manager.preview.quiz', ['quiz' => $quiz->name]) }}">
                    @csrf
