      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card shadow-2-strong" style="border-radius: 1rem;">
          <div class="card-body p-5">
            ...
            <h1 class="mb-5 text-danger fw-bold">Sign up</h1>
            
            <form method="POST" action="{{ route('register') }}">
              @csrf
              <div class="form-outline mb-2">
                <label for="email" class="col-md-12 col-form-label">{{ __('Nama Lengkap') }}</label>
              ...
              <p>Sudah punya akun?                     
                <a href="/login" type="button" class="btn btn-outline-danger">Masuk disini</a>
              </p>
