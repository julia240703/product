                    ...
                    <div class="header-right">
                        ...
                        <div class="profile-box ml-15">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                                <li>
                                    <a href="{{ route('admin.profile') }}"> <i class="lni lni-user"></i> {{ __('Profile Saya') }}</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.upload') }}"> <i class="lni lni-cloud-upload"></i> {{ __('Upload File') }}</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.manageScore') }}"> <i class="lni lni-pencil"></i> {{ __('Kelola Nilai') }}</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.control') }}"> <i class="lni lni-warning"></i> {{ __('Control Panel') }}</a>
                                </li>
                                <li>
